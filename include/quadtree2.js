        ...
        !(function c(a, d, e) {
          function f(a, b) {
            return this instanceof f
              ? (g(a)
                  ? ((b = a[1]), (a = a[0]))
                  : "object" == typeof a && a && ((b = a.y), (a = a.x)),
                (this.x = f.clean(a || 0)),
                void (this.y = f.clean(b || 0)))
              : new f(a, b);
          }
          var g = function (a) {
          ...
          (f.prototype = {
            change: function (a) {
              if (a)
                ...
                for (var b = this.observers.length - 1; b >= 0; b--)
                  this.observers[b](this);
              return this;
            },
            ignore: function (a) {
              if (this.observers)
                for (var b = this.observers, c = b.length; c--; )
                  b[c] === a && b.splice(c, 1);
              return this;
            },
            set: function (a, b, c) {
              return (
                "number" != typeof a && ((c = b), (b = a.y), (a = a.x)),
                this.x === a && this.y === b
                  ? this
                  : ((this.x = f.clean(a)),
                    (this.y = f.clean(b)),
                    c !== !1 ? this.change() : void 0)
              );
            },
            zero: function () {
              return this.set(0, 0);
            ...
            negate: function (a) {
              return a
                ? new this.constructor(-this.x, -this.y)
                : this.set(-this.x, -this.y);
            },
            add: function (a, b) {
              return b
                ? new this.constructor(this.x + a.x, this.y + a.y)
                : ((this.x += a.x), (this.y += a.y), this.change());
            },
            ...
            multiply: function (a, b) {
              var c, d;
              return (
                "number" != typeof a ? ((c = a.x), (d = a.y)) : (c = d = a),
                b
                  ? new this.constructor(this.x * c, this.y * d)
                  : this.set(this.x * c, this.y * d)
              );
            },
            rotate: function (a, b, c) {
              ...
              return (
                ...
                (d = h * f - b * i * g),
                (e = b * i * f + h * g),
                c ? new this.constructor(d, e) : this.set(d, e)
              );
            },
            length: function () {
              var a = this.x,
            ...
            normalize: function (a) {
              ...
              return a
                ? new this.constructor(this.x * c, this.y * c)
                : this.set(this.x * c, this.y * c);
            },
            equal: function (a, b) {
              return (
                b === e && ((b = a.y), (a = a.x)),
                f.clean(a) === this.x && f.clean(b) === this.y
              );
            },
            abs: function (a) {
            ...
            isPointOnLine: function (a, b) {
              return (
                (a.y - this.y) * (a.x - b.x) === (a.y - b.y) * (a.x - this.x)
              );
            },
            toArray: function () {
          ...
          return (
            ...
            a ||
              ...
              "undefined" != typeof b && "object" == typeof b.exports
                ? (b.exports = f)
                : (window.Vec2 = window.Vec2 || f)),
            f
          );
        })();
      },
    ...
    3: [
      function (a, b) {
        ...
        (c = function (a, b, c) {
          var h,
            ...
            m = {
              ...
              removeQuadrantParentQuadrants: function (a, b) {
                a.parent_ &&
                  b[a.parent_.id_] &&
                  (delete b[a.parent_.id_],
                  m.removeQuadrantParentQuadrants(a.parent_, b));
              },
              ...
              getIntersectingQuadrants: function q(a, b, c) {
                var d, e;
                if (!b.intersects(a[k.p], a[k.r]))
                  return void m.removeQuadrantParentQuadrants(b, c.biggest);
              ...
              getSmallestIntersectingQuadrants: function (a, b, c) {
                ...
                for (d in c.leaves)
                  c.biggest[d] &&
                    ((e = m.getSubtreeTopQuadrant(c.leaves[d], c.biggest)),
                    m.removeQuadrantChildtree(e, c.biggest));
                return c.biggest;
              },
              removeQuadrantObjects: function (a) {
                ...
                for (b = 0; b < c.length; b++)
                  delete i.quadrants_[c[b].obj[k.id]][c[b].quadrant.id_];
                return c;
              },
              ...
              removeObjectFromQuadrant: function (a, b) {
                b.removeObject(a[k.id]),
                  delete i.quadrants_[a[k.id]][b.id_],
                  !b.hasChildren() && b.parent_ && m.refactorSubtree(b.parent_);
              },
              refactorSubtree: function (a) {
                ...
                if (!a.refactoring_) {
                  ...
                  if (
                    ((d = a.getObjectCountForLimit()),
                    !(d > i.quadrantObjectsLimit_))
                  ) {
                    for (
                      a.refactoring_ = !0, b = 0;
                      b < a.children_.length;
                      b++
                    ) {
                      e = a.children_[b];
                      for (c in e.objects_)
                        (f = e.objects_[c]),
                          m.removeObjectFromQuadrant(f, e),
                          m.addObjectToQuadrant(f, a);
                    }
                    a.looseChildren(),
                      (a.refactoring_ = !1),
                      a.parent_ && m.refactorSubtree(a.parent_);
                  }
                }
              },
              updateObjectQuadrants: function (a) {
                var b,
                  c = i.quadrants_[a[k.id]],
                ...
                for (b = 0; b < j.length; b++)
                  c[j[b]] && m.removeObjectFromQuadrant(a, c[j[b]]);
              },
              addObjectToQuadrant: function (a, b) {
                var c = a[k.id];
                void 0 === i.quadrants_[c] && (i.quadrants_[c] = {}),
                  (i.quadrants_[c][b.id_] = b),
                  b.addObject(c, a);
              },
              populateSubtree: function (a, b) {
                ...
                if ((b || (b = i.root_), b.hasChildren())) {
                  ...
                  b.getObjectCount() < i.quadrantObjectsLimit_ ||
                  b.size_.x < i.quadrantSizeLimit_.x
                )
                  m.addObjectToQuadrant(a, b);
                else
                  for (
                    b.makeChildren(m.nextQuadrantId()),
                      f = m.removeQuadrantObjects(b),
                      f.push({
                        obj: a,
                        quadrant: b,
                      }),
                    ...
                    m.populateSubtree(f[c].obj, f[c].quadrant);
              },
              init: function () {
                var a;
                i.quadrantLevelLimit_ || (i.quadrantLevelLimit_ = 6),
                  j.byCallbackObject(i, l.data.necessary),
                  (i.root_ = new g(
                    new d(0, 0),
                    i.size_.clone(),
                    m.nextQuadrantId(1)
                  )),
                  (a = Math.pow(2, i.quadrantLevelLimit_)),
                  (i.quadrantSizeLimit_ = i.size_.clone().divide(a)),
                  (i.inited_ = !0);
              },
              ...
              checkObjectKeys: function (a) {
                j.isNumber(a[k.id], k.id),
                  j.isNumber(a[k.r], k.r),
                  j.hasNoKey(i.objects_, a[k.id], k.id),
                  j.byCallbackObject(a, l.k.necessary, k);
              },
              setObjId: function (a) {
                i.autoId_ && !a[k.id] && (a[k.id] = m.nextId());
              },
              removeObjectById: function (a) {
                j.hasKey(i.objects_, a, k.id),
                  m.removeObjectFromQuadrants(i.objects_[a]),
                  delete i.objects_[a];
              },
              updateObjectById: function (a) {
                j.hasKey(i.objects_, a, k.id),
                  m.updateObjectQuadrants(i.objects_[a]);
              },
              getObjectsByObject: function (a) {
                var b,
                  c,
                  d = i.quadrants_[a[k.id]],
                  e = {
                    objects: {},
                    quadrants: {},
                  };
                for (c in d)
                  for (
                    d[c].getObjectsUp(e), b = 0;
                    b < d[c].children_.length;
                    b++
                  )
                    d[c].children_[b].getObjectsDown(e);
            ...
            o = {
              ...
              setQuadrantObjectsLimit: function (a) {
                void 0 !== a &&
                  (j.isNumber(a, "quadrantObjectsLimit_"),
                  (i.quadrantObjectsLimit_ = a));
              },
              ...
              setQuadrantLevelLimit: function (a) {
                void 0 !== a &&
                  (j.isNumber(a, "quadrantLevelLimit_"),
                  (i.quadrantLevelLimit_ = a));
              },
              setObjectKey: function (a, b) {
                j.fnFalse(m.checkInit),
                  void 0 !== b &&
                    (j.hasKey(k, a, a),
                    j.isString(b, a),
                    "id" === a && (i.autoId_ = !1),
              ...
              removeObject: function (a) {
                m.checkInit(!0),
                  j.hasKey(a, k.id, k.id),
                  m.removeObjectById(a[k.id]);
              },
              ...
              updateObject: function (a) {
                m.checkInit(!0),
                  j.hasKey(a, k.id, k.id),
                  m.updateObjectById(a[k.id]);
              },
              getPossibleCollisionsForObject: function (a) {
                return (
                  m.checkInit(!0),
                  j.hasKey(a, k.id, k.id),
                  m.getObjectsByObject(a)
                );
              },
              ...
              getQuadrantCount: function (a) {
                return a
                  ? Object.keys(i.quadrants_[a[k.id]]).length
                  : 1 + i.root_.getChildCount(!0);
              },
          ...
          this.setSize(a),
            this.setQuadrantObjectsLimit(b),
            this.setQuadrantLevelLimit(c);
        }),
          (b.exports = c);
      },
      {
        ...
        var c = {
          ...
          arrayDiffs: function (a, b) {
            var c = 0,
              ...
              f = [];
            for (
              a.sort(this.compare), b.sort(this.compare);
            ...
            return (
              c < a.length
                ? e.push.apply(e, a.slice(c, a.length))
                : f.push.apply(f, b.slice(d, b.length)),
              [e, f]
            );
          },
        };
      ...
      function (a, b) {
        ...
        (c.prototype = {
          setSize: function (a) {
            a &&
              ((this.size_ = a),
              (this.rad_ = a.multiply(0.5, !0)),
              (this.center_ = this.leftTop_.add(this.rad_, !0)),
              (this.leftBot_ = this.leftTop_.clone()),
              (this.leftBot_.y += a.y),
              (this.rightTop_ = this.leftTop_.clone()),
              (this.rightTop_.x += a.x),
              (this.rightBot_ = this.leftTop_.add(a, !0)),
          ...
          makeChildren: function (a) {
            return this.children_.length > 0
              ? !1
              : (this.children_.push(
                  new c(this.leftTop_, this.rad_, a++, this),
                  new c(this.topMid_, this.rad_, a++, this),
                  new c(this.leftMid_, this.rad_, a++, this),
                  new c(this.center_, this.rad_, a++, this)
                ),
                a);
          },
          ...
          removeObjects: function (a, b) {
            ...
            return (
              (this.objectCount_ = 0),
              (b && 1 !== b) ||
                (this.parent_ && this.parent_.removeObjects(a, 1)),
              (b && -1 !== b) ||
                this.children_.forEach(function (b) {
                  b.removeObjects(a, -1);
                }),
              a
            );
          ...
          getObjectCount: function (a, b) {
            ...
            return (
              a &&
                this.children_.forEach(function (d) {
          ...
          intersects: function (a, b) {
            ...
            return c.x > this.rad_.x + b
              ...
              ? !0
              : ((cornerDistSq =
                  Math.pow(c.x - this.rad_.x, 2) +
                  Math.pow(c.y - this.rad_.y, 2)),
          ...
          getObjectsDown: function (a) {
            ...
            if (!a.quadrants[this.id_]) {
              ...
              for (b = 0; b < this.children_.length; b++)
                this.children_[b].getObjectsDown(a);
            }
          },
        }),
          (b.exports = c);
      ...
      function (a, b) {
        ...
        (d.prototype = {
          ...
          isString: function (a, b) {
            "string" == typeof a ||
              a instanceof String ||
              c.thrower("NaS", "Not a String", b);
          },
          isVec2: function (a, b) {
            var d = !1;
            (d = "object" != typeof a || void 0 === a.x || void 0 === a.y),
              d && c.thrower("NaV", "Not a Vec2", b);
          },
          ...
          hasKey: function (a, b, d) {
            this.isDefined(a, "obj"),
              -1 === Object.keys(a).indexOf(b.toString()) &&
                c.thrower("OhnK", "Object has no key", d + b);
          },
          hasNoKey: function (a, b, d) {
            this.isDefined(a, "obj"),
              -1 !== Object.keys(a).indexOf(b.toString()) &&
                c.thrower("OhK", "Object has key", d + b);
          },
          fnFalse: function (a) {
            a() &&
              c.thrower("FarT", "function already returns true", c.fnName(a));
          },
